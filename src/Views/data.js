const PRODUCTS = [
  {
    ...
    "description": "Paracetamol is a common medication used to treat pain and fever.",
    "price": 25,
    "minGram": 500,
    "maxGram": 1000,
    "sideEffects": ["Nausea", "Allergic reactions", "Liver damage (overdose)"],
    "images": [
  ...
  },
  {
    ...
    "description": "Crocin contains paracetamol and is used for headache and fever relief.",
    "price": 30,
    "minGram": 500,
    "maxGram": 650,
    "sideEffects": ["Dizziness", "Nausea", "Skin rash"],
    "images": [
  ...
  },
  {
    ...
    "description": "Calpol is a pediatric paracetamol syrup used for reducing fever.",
    "price": 45,
    "minGram": 120,
    "maxGram": 250,
    "sideEffects": ["Mild rash", "Vomiting", "Sleepiness"],
    "images": [
  ...
  },
  {
    ...
    "description": "Ibuprofen is used to reduce fever and treat pain.",
    "price": 40,
    "minGram": 200,
    "maxGram": 400,
    "sideEffects": ["Stomach pain", "Heartburn", "Dizziness"],
    "images": [
      "https://pics.walgreens.com/prodimg/644980/450.jpg",
  ...
  },
  {
    ...
    "description": "Combiflam combines ibuprofen and paracetamol.",
    "price": 50,
    "minGram": 400,
    "maxGram": 650,
  ...
  },
  {
    ...
    "description": "Benadryl is an antihistamine used for allergy symptoms.",
    "price": 35,
    "minGram": 8,
    "maxGram": 25,
  ...
  },
  {
    ...
    "description": "Ascoril is used to treat cough.",
    "price": 60,
    "minGram": 100,
    "maxGram": 200,
    "sideEffects": ["Dizziness", "Nausea", "Palpitations"],
    "images": [
  ...
  },
  {
    ...
    "description": "Provides relief from multiple cold symptoms.",
    "price": 40,
    "minGram": 500,
    "maxGram": 650,
  ...
  },
  {
    ...
    "description": "Helps prevent vitamin deficiency.",
    "price": 150,
    "minGram": 500,
    "maxGram": 1000,
  ...
  },
  {
    ...
    "description": "Provides energy and vitality.",
    "price": 250,
    "minGram": 30,
    "maxGram": 60,
  ...
  },
  {
    ...
    "minGram": 200,
    "maxGram": 400,
    "sideEffects": ["Diarrhea", "Chalky taste"],
    "images": [
      ...
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEzvvHACyRq6SEUP5fvlqt3PdramdFd7dkKg&s",
  ...
  },
  {
    ...
    "description": "Provides quick relief from heartburn.",
    "price": 25,
    "minGram": 150,
    "maxGram": 300,
  ...
  },
  {
    ...
    "description": "Relieves gas and acidity quickly.",
    "price": 15,
    "minGram": 5,
    "maxGram": 10,
  ...
  },
  {
    ...
    "minGram": 500,
    "maxGram": 1000,
    "sideEffects": ["Nausea", "Diarrhea", "Weakness"],
    "images": [
  ...
  },
  {
    ...
    "description": "Helps manage diabetes.",
    "price": 75,
    "minGram": 500,
    "maxGram": 1000,
